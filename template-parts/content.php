        ...
        <div id="post-<?php the_ID(); ?>" <?php post_class('blog-wrapper'); ?> data-wow-delay=".3s">
            ...
            <div class="blog-text blog2-text blog-details-content">
                <div class="blog-meta">
                    ...
                    <span><i class="fas fa-list"></i> <?php
        ...
        <div class="blog-text">
            ...
            <?php if( $show_readmore ): ?>
                <div class="blog-d-btn">
                    <a class="link" href="<?php the_permalink(); ?>"> <?php print wp_kses_post($readmore_text ); ?> <i class="<?php print wp_kses_post($readmore_icon ); ?>"></i></a>
                </div>
            <?php endif; ?>
